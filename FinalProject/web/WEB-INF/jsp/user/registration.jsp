                ...
                <div  class="col-md-12">
                    <form class="form" action="ProjectServlet" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="login"  placeholder="login" maxlength="15"  class="form-control" required autofocus>
                        </div>
                        <c:if test="${exception !=null}"><h7 class="text-danger">${exception}</h7></c:if>
                        <div class="form-group">
                            <label class="text-info">Введите пароль:</label><br>
                            <input type="password" name="password" maxlength="8" maxlength="25" placeholder="password" class="form-control" required autofocus>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="phone"  placeholder="phone" maxlength="13" class="form-control" required autofocus>
                        </div>
                        <div class="form-group">

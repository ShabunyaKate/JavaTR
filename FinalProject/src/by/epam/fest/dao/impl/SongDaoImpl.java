...
public class SongDaoImpl extends DaoImpl implements SongDao {
        ...
        @Override
        public Integer create(Song song) throws DaoException {
            Connection con = null;
        ...
        @Override
        public Song read(Integer id) throws DaoException {
            Connection con = null;
            String sql = "SELECT `name`,`musician_id`  FROM `song` WHERE `id` = ?";
            PreparedStatement statement = null;
            ResultSet resultSet = null;
            try {
                con = getDBConnection();
                ...
                if(resultSet.next()) {
                    ...
                    song.setMusician_id(resultSet.getInt("musician_id"));
                }
                return song;
            } catch(SQLException e) {
                throw new DaoException(e);
        ...
        @Override
        public void update(Song song) throws DaoException {
//            Connection con = null;
...
//            }
    ...
    @Override
    public List<Song> readAllSongsByMusician(Integer musician_id) throws DaoException {
        Connection con = null;
